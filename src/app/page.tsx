    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold text-gray-900">DR Market Research</span>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 pt-20 text-center sm:pt-32">
        <div className="mx-auto max-w-2xl">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">
            Research companies.
            <br />
            <span className="text-blue-600">Make better decisions.</span>
          </h1>
      ...
      {/* Features */}
      <section className="border-t border-gray-100 bg-white/60 py-20">
